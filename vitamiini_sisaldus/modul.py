...
from random import *
#при запуске которой происходит заполнение двух списков: абитуриенты[], баллы[]
...
def suurim_d_vitamiin(i:list,v:list):
    """
    teeb max vitamiini arvu ja siis leiab palk indexit ja nimi indeksid
    """
    palk=max(v)
    ind=v.index(palk)
    nimi=i[ind]
